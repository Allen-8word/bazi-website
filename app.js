...
const BARNUM = {
  fire: {
    title: '你的命局有一處值得留意的張力',
    items: [
      '你內心有明確的方向感與熱情，但身邊的人有時看不見你真正的計畫。',
      '你習慣獨自承擔，即使在你最希望被理解的時刻。',
      '你的直覺常常很準，這既是優勢，有時也讓你略過了驗證的步驟。'
    ],
    biz: '從命理觀察，你在合作關係中容易遇到「看似互補、實則消耗」的對象。這是觀察視角，最終判斷仍應以實際相處與專業評估為主。'
  },
  metal: {
    title: '你對自己的期待，往往比別人對你的更高',
    items: [
      '你的決斷力讓你看起來很強，內心卻常常希望有一個值得信任的對話對象。',
      '你的標準很高，這讓你在合作中經常獨自承擔關鍵環節。',
      '你不缺機會，較常糾結的是如何判斷「真機會」與「漂亮選項」的差別。'
    ],
    biz: '從命理觀察，你的命格傾向於擔任整合與資源協調的角色。這只是一種視角，實際發展仍取決於個人選擇與環境條件。'
  },
  wood: {
    title: '你的成長需要一片自己的土壤',
    items: [
      '你看似配合度高，但內心其實有一條不能被觸碰的底線。',
      '你願意給予，卻常在付出後感到莫名的疲倦。',
      '你比你想像中更需要「自己說了算」的空間。'
    ],
    biz: '從命理觀察，你較適合「分區治理、共識先行」的合作模式。這是一種傾向描述，並非具體建議。'
  },
  water: {
    title: '你的智慧，常常被你自己懷疑',
    items: [
      '你能看穿人心，卻也容易因為看得太透而難以決定。',
      '你的彈性是優勢，但有時被誤讀為立場不堅定。',
      '你習慣同時思考多種可能，這讓你決策稍慢，但通常較為周全。'
    ],
    biz: '從命理觀察，與你互補的夥伴特質傾向於「執行果斷、能承擔決策」的人。這僅供參考，實際關係仍需相處驗證。'
  },
  earth: {
    title: '你的穩定，其實是一種高度自律',
    items: [
      '你看似隨和，但對「被理解」這件事比誰都在意。',
      '你的責任感是團隊的支柱，有時也成了你最大的負擔。',
      '你常擔心讓人失望，卻很少有人真正擔心過讓你失望。'
    ],
    biz: '從命理觀察，你的命格傾向於擔任「整合型」角色，這類角色容易承擔較多隱性責任。這是一個觀察視角，提供你參考。'
  }
};
