...
const dayStemTitles = {
  甲: {
    ...
    title: '青木開山者',
    shortTitle: '青木修士',
    genderTitles: { male: '擎天青帝', female: '扶桑仙子' },
    genderShortTitles: { male: '青帝', female: '扶桑' },
  ...
  乙: {
    ...
    title: '靈藤療癒者',
    shortTitle: '靈藤修士',
    genderTitles: { male: '青藤道君', female: '百花仙子' },
    genderShortTitles: { male: '青藤', female: '百花' },
  ...
  丙: {
    ...
    title: '烈陽傳道者',
    shortTitle: '烈陽修士',
    genderTitles: { male: '炎陽赤帝', female: '朱雀聖女' },
    genderShortTitles: { male: '炎陽', female: '朱雀' },
  ...
  丁: {
    ...
    title: '星燈策士',
    shortTitle: '星燈修士',
    genderTitles: { male: '燭幽道君', female: '流螢仙子' },
    genderShortTitles: { male: '燭幽', female: '流螢' },
  ...
  戊: {
    ...
    title: '山岳守護者',
    shortTitle: '山岳修士',
    genderTitles: { male: '鎮嶽帝君', female: '后土聖女' },
    genderShortTitles: { male: '鎮嶽', female: '后土' },
  ...
  己: {
    ...
    title: '靈田培育者',
    shortTitle: '靈田修士',
    genderTitles: { male: '沃土道君', female: '沃野仙子' },
    genderShortTitles: { male: '沃土', female: '沃野' },
  ...
  庚: {
    ...
    title: '天刃破局者',
    shortTitle: '天刃修士',
    genderTitles: { male: '殺伐劍尊', female: '白虎聖女' },
    genderShortTitles: { male: '劍尊', female: '白虎' },
  ...
  辛: {
    ...
    title: '靈玉鑄器師',
    shortTitle: '靈玉修士',
    genderTitles: { male: '璇璣道君', female: '流光仙子' },
    genderShortTitles: { male: '璇璣', female: '流光' },
  ...
  壬: {
    ...
    title: '滄海行者',
    shortTitle: '滄海修士',
    genderTitles: { male: '滄海道君', female: '滄瀾仙子' },
    genderShortTitles: { male: '滄海', female: '滄瀾' },
  ...
  癸: {
    ...
    title: '靈泉洞察者',
    shortTitle: '靈泉修士',
    genderTitles: { male: '霧隱道君', female: '雲露仙子' },
    genderShortTitles: { male: '霧隱', female: '雲露' },
