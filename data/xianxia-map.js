...
const dayStemTitles = {
  甲: {
    ...
    title: '青木開山者',
    shortTitle: '青木修士',
    genderTitles: { male: '青木開山者', female: '青木靈華者' },
    genderShortTitles: { male: '青木修士', female: '青木靈修' },
  ...
  乙: {
    ...
    title: '靈藤療癒者',
    shortTitle: '靈藤修士',
    genderTitles: { male: '靈藤行者', female: '靈藤療癒者' },
    genderShortTitles: { male: '靈藤修士', female: '靈藤靈修' },
  ...
  丙: {
    ...
    title: '烈陽傳道者',
    shortTitle: '烈陽修士',
    genderTitles: { male: '烈陽傳道者', female: '朱陽明華者' },
    genderShortTitles: { male: '烈陽修士', female: '朱陽靈修' },
  ...
  丁: {
    ...
    title: '星燈策士',
    shortTitle: '星燈修士',
    genderTitles: { male: '星燈策士', female: '星燈靈眸者' },
    genderShortTitles: { male: '星燈修士', female: '星燈靈修' },
  ...
  戊: {
    ...
    title: '山岳守護者',
    shortTitle: '山岳修士',
    genderTitles: { male: '山岳守護者', female: '厚土鎮心者' },
    genderShortTitles: { male: '山岳修士', female: '厚土靈修' },
  ...
  己: {
    ...
    title: '靈田培育者',
    shortTitle: '靈田修士',
    genderTitles: { male: '靈田培育者', female: '靈田養心者' },
    genderShortTitles: { male: '靈田修士', female: '靈田靈修' },
  ...
  庚: {
    ...
    title: '天刃破局者',
    shortTitle: '天刃修士',
    genderTitles: { male: '天刃破局者', female: '霜刃裁決者' },
    genderShortTitles: { male: '天刃修士', female: '霜刃靈修' },
  ...
  辛: {
    ...
    title: '靈玉鑄器師',
    shortTitle: '靈玉修士',
    genderTitles: { male: '靈玉鑄器師', female: '靈玉凝光者' },
    genderShortTitles: { male: '靈玉修士', female: '靈玉靈修' },
  ...
  壬: {
    ...
    title: '滄海行者',
    shortTitle: '滄海修士',
    genderTitles: { male: '滄海行者', female: '滄海觀瀾者' },
    genderShortTitles: { male: '滄海修士', female: '滄海靈修' },
  ...
  癸: {
    ...
    title: '靈泉洞察者',
    shortTitle: '靈泉修士',
    genderTitles: { male: '靈泉洞察者', female: '靈泉映心者' },
    genderShortTitles: { male: '靈泉修士', female: '靈泉靈修' },
