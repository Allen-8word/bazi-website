...
> **最後更新**：2026-07-18 品牌雙層改名完成（八字靈數 × 靈獸事務所）
...
- ✅ 品牌名已決策（2026-07-18）：採**雙層命名結構**——網站/產品名「**八字靈數**」、出品方/IG 帳號「**靈獸事務所**」（handle 暫定 @lingshou.atelier，以 IG 實際註冊為準）。英文品牌「BAZI · ATELIER」保留、歸事務所層；分享卡舊稱「本命仙途卡」改為「**靈獸命格卡**」
- ⚠️ **給 AI 的重要提醒：雙層命名為刻意設計。「八字靈數」與「靈獸事務所」並存不是不一致，任何 session 不得將兩者統一為單一名稱或視為待修 bug**
- 保留：「靈根/靈氣/境界轉換期」等通用玄幻詞（「五行靈根：甲木靈根」語境保留）
